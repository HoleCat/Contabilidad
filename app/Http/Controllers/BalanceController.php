...
class BalanceController extends Controller
{
    ...
    public function importar(Request $request) {
        ...
        $array_data = Txtexportaciones::csv_to_array($ruta, '|');
    ...
    public function exportar(Request $request)
    {
        ...
        foreach ($array_data as $item) {
            ...
            foreach ($item as $cell_value) {
                ...
                $spreadsheet->setActiveSheetIndex(3)->setCellValue($cell_id, $cell_value);
                $cont_2++;
            }
            $spreadsheet->setActiveSheetIndex(3)->setCellValue("Y".$cont_1, "=+R".$cont_1."-S".$cont_1);
            $cont_1++;
        }
        $cont_1++;
        $spreadsheet->setActiveSheetIndex(3)->setCellValue("Y".$cont_1, "=+SUM(Y2:Y".($cont_1-2).")");
