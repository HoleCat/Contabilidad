                ...
                <div class="col-12">
                    <table>
                        <tbody>
                            ...
                            <tr><td class="col-4 text-left">Fecha de elaboracion   </td><td class="col-8 text-left">: {{ $liquidaciondetalle->created_at}}</td></tr>
                            ...
                            <tr><td class="col-4 text-left">Asunto                 </td><td class="col-8 text-left">: {{ $asunto }}</td></tr>
                        </tbody>
                    </table>
                </div>
                <br>
