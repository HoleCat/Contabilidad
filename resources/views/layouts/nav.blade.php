<nav class="nav-index navbar navbar-expand-md navbar-dark bg-dark shadow-sm fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    ...
                    <li class="nav-item" onclick="getview('#content','/Xml',confirmacion)">
                        <a class="nav-link" id="nav-balance">Xml</a>
                    </li>
